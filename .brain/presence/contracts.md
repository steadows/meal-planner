...
status: active
phase: "follow-up PR (ungated, AUTONOMOUS_WORK mode): pantry ask (next_ask_on migration, Pantry +4, FakePantry parity, seed_loader layer), load_prompt CWE-22, runner kills child on any exception — seams next. Queued, gated on Steve/ADR-0001: job_run migration + run(hold_fds) + background/plan_state layers"
...
current_ticket: none
touches: [meals/config.py, meals/db.py, meals/contracts.py, meals/claude_runner.py, meals/fakes/, pyproject.toml, tests/conftest.py, tests/test_contracts.py, tests/test_db.py, tests/test_claude_runner.py, tests/test_fakes.py]
updated: 2026-09-26T04:43:26Z
---
